...
const ProductListing = () => {
  ...
  const handleViewOptionChange = (newViewOption: ProductListViewNameEnum) => {
    setCurrentView(newViewOption);
  };
  return (
    <div className="flex flex-col space-y-4">
      ...
      <ProductListControls
        ...
        onChangeViewOption={handleViewOptionChange}
      />
      {/* Product List */}
      <section className="">{renderProducts(currentView)}</section>
    </div>
  );
};
...
const renderProducts = (viewOption: ProductListViewNameEnum) => {
  switch (viewOption) {
